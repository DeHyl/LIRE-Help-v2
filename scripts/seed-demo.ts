...
function buildConversations(
  ...
  return [
    ...
    },
    {
      ...
      preview: "DHL is disputing $47,200 in Q4 CAM charges, claiming the reconciliation includes items outside the lease scope. Requesting full line-item audit.",
    ...
    },
    {
      ...
      preview: "Security camera captured 3 individuals cutting through fence at the east perimeter of Lot A at 2:14 AM. One vehicle partially blocked. Police report filed.",
    ...
    },
    {
      ...
      preview: "Lam Research Unit 9 reporting rodent activity near the utility room. Food-grade equipment present — health department could be notified if not addressed promptly.",
    ...
    },
    {
      ...
      inboxSlug: "escalations",
      customerId: customerIds["cust-sysco-stock"]!,
      preview: "Electrical panels B and C tripped during peak load. Two refrigeration units running on generator. PG&E notified but 4-6 hour restore window.",
    ...
    },
    {
      ...
      inboxSlug: "support",
      customerId: customerIds["cust-tesla-frm"]!,
      preview: "Tesla Components reporting that the office section of Unit 3 has been above 82°F for two days. HVAC unit appears to be running but not cooling effectively.",
    ...
    },
    {
      ...
      inboxSlug: "vip",
      customerId: customerIds["cust-usfoods-stock"]!,
      preview: "US Foods requesting amendment to add 2 additional dock doors to their allocation for Q3 volume surge. Willing to pay premium for priority access.",
...
async function seedPlatformKnowledge(tenantId: string) {
  const existing = await sql`SELECT id FROM platform_knowledge LIMIT 1`;
  if (existing.length > 0) {
    console.log("Platform knowledge already seeded — skipping.");
    return;
  }

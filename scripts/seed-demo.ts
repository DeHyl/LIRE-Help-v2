...
async function upsertTags(tenantId: string) {
  const tags = [
    ...
    { name: "roof-maintenance", slug: "roof-maintenance", color: "#dc2626" },
    { name: "water-damage", slug: "water-damage", color: "#2563eb" },
    { name: "plumbing", slug: "plumbing", color: "#0891b2" },
    { name: "make-ready", slug: "make-ready", color: "#16a34a" },
    { name: "move-in", slug: "move-in", color: "#22c55e" },
    { name: "onboarding", slug: "onboarding", color: "#059669" },
    { name: "pass-through", slug: "pass-through", color: "#a855f7" },
  ];
...
async function upsertCustomers(tenantId: string, propertyIds: string[]) {
  const customers = [
    ...
    {
      externalId: "cust-redwood-stock",
      name: "Elena Vasquez",
      email: "e.vasquez@redwoodfulfillment.com",
      company: "Redwood Fulfillment (incoming)",
      tier: "priority",
      health: "stable",
      propertyId: propertyIds[1] ?? null,
    },
...
function buildConversations(
  ...
  return [
    ...
    {
      externalId: "conv-fremont-roof-leak",
      subject: "Active roof leak — Unit 6 R&D lab, water on equipment",
      status: "open",
      priority: "urgent",
      assignmentState: "assigned",
      assigneeIndex: 3,
      ...
      messages: [
        ...
        },
        {
          type: "teammate",
          author: "AI Concierge",
          body: "Nadia — classifying this as emergency maintenance. Roof is landlord responsibility per Section 12.4 of your lease. I've paged Travis Ortega and dispatched Summit Roofing (our preferred Fremont roofer) plus an emergency tarp crew from AllDry Restoration. ETA 40–55 minutes. Please move anything portable away from the drip zone if safe to do so, and leave the tarp where it is — the crew will build a proper catchment.",
          minutesAfterCreation: 2,
        },
        {
          type: "customer",
        ...
        },
        {
          type: "internal_note",
          author: "Travis Ortega",
          body: "Summit tech is 20 min out — bringing a self-adhered membrane patch for temporary seal. AllDry ETA 35 min with industrial dehumidifiers. Flagging to insurance broker: documented water contact with an energized outlet, so we want an electrical inspection before re-energizing. Pulling the roof warranty file — this area was last inspected 11 months ago.",
          minutesAfterCreation: 18,
        },
        {
          type: "internal_note",
          author: "Travis Ortega",
          body: "Summit on site. Source identified as failed HVAC curb flashing (not a membrane failure). Temporary seal in place, leak stopped. AllDry extracting standing water. Electrician scheduled tomorrow 8 AM to clear the outlet. Full roof patch scheduled Saturday weather-permitting. Drafting incident report for Nadia + insurance.",
          minutesAfterCreation: 52,
        },
      ],
    },
    {
      externalId: "conv-oakland-pipe-burst",
      subject: "2 AM pipe burst — flooding in loading corridor Zone C",
      status: "open",
      priority: "urgent",
      assignmentState: "assigned",
      assigneeIndex: 1,
      ...
      messages: [
        ...
        },
        {
          type: "teammate",
          author: "AI Concierge",
          body: "Marcus — the main water shutoff for the Oakland DC is in Mechanical Room 2, north wall behind the red door. Quarter-turn lever marked WATER MAIN. Turn it 90° clockwise. Once the flow stops, do NOT re-energize any affected electrical panels until we inspect. I've already paged Marcus Chen and dispatched Reliant Plumbing (24/7 emergency), ETA 25 minutes. I'm also alerting your regional ops contact at Amazon.",
          minutesAfterCreation: 2,
        },
        {
          type: "customer",
        ...
        },
        {
          type: "internal_note",
          author: "Marcus Chen",
          body: "Dispatched AllDry Restoration for water extraction — ETA 45 min. Reliant Plumbing tech confirmed at gate. Initial look: 2-inch supply line failed at a threaded joint above the corridor, likely slow corrosion. Building pre-action sprinkler zone in corridor C is now offline until we re-pressurize — notifying Alameda County FD as required. Incident ticket TKT-2931 opened. Inventory impact review kicking off at 7 AM with Amazon.",
          minutesAfterCreation: 22,
        },
        {
          type: "internal_note",
          author: "Marcus Chen",
          body: "Plumber replaced the failed joint, pressure-tested the line, no leaks. Sprinkler recharged, FD notified of restoration. AllDry extracting now, bringing in 6 dehumidifiers + air movers for 72-hour dry-down. Five pallets showed minor water contact — Amazon is pulling those for QA. Full incident report and cost summary will hit Jordan's inbox by 7 AM.",
          minutesAfterCreation: 95,
        },
      ],
    },
    {
      externalId: "conv-stockton-make-ready",
      subject: "Make-ready request — Redwood Fulfillment move-in Unit 4 (T-30 days)",
      status: "pending",
      priority: "medium",
      assignmentState: "assigned",
      assigneeIndex: 2,
      ...
      messages: [
        ...
        },
        {
          type: "teammate",
          author: "AI Concierge",
          body: "Welcome, Elena — congrats on the signing. Kicking off on our side: professional deep clean, dock door inspection + seal replacement on all 4 doors, HVAC filter change and full system check (including the freight door curtain), paint touch-ups where prior tenant had signage, high-bay LED replacements, and parking restriping for your truck bays.\n\nFrom your side I'll need: COI naming Northstar Industrial Group as additional insured, W-9 for billing, initial employee list for badge provisioning (we can do the remaining 7 later), and internet/phone provider preference (Comcast Business or AT&T).\n\nI've opened make-ready ticket MR-0142 and assigned Priya Nair as your point of contact. Priya will walk the unit with you next week.",
          minutesAfterCreation: 8,
        },
        {
          type: "customer",
        ...
        },
        {
          type: "internal_note",
          author: "Priya Nair",
          body: "Walk-through Tuesday 10 AM on the calendar. Work orders sent: JanPro (deep clean, $2,400 est) and Able Door (dock service, $1,100 est). HVAC filters in stock — I'll swap Thursday. Paint touch-up assigned to in-house handyman. Comcast 1 Gbps line submitted — 10–14 day install window, tight but workable. Flagging: prior tenant's high-pile storage rack permit transfers to Redwood — Stockton Fire sign-off needed by Day 25.",
          minutesAfterCreation: 200,
        },
        {
          type: "teammate",
          author: "AI Concierge",
          body: "Status for Elena: Comcast install window is 10–14 days; requesting prioritization. Fire permit transfer in motion, target closed by Day 25. All other make-ready items tracking on-time. I'll send a weekly status update each Friday through move-in.",
          minutesAfterCreation: 260,
        },
      ],
    },
    {
      ...
      messages: [
        ...
        },
        {
          type: "teammate",
          author: "AI Concierge",
          body: "Good question, Derek. This is a new fee the City of Fremont rolled out this quarter under the Alameda Countywide Clean Water Program. It's a per-parcel stormwater utility charge the City bills to Northstar, and we pass it through under Section 9.2(c) of your lease (\"Taxes and municipal assessments attributable to the Premises\"). Your share is pro-rated by leased square footage:\n\n• Total parcel charge: $9,280 / quarter\n• Your sq ft share (19.8%): $1,840.17\n\nHappy to send the City's bill and the pro-ration worksheet for your AP team. Want me to set up a short call with Travis to walk it through?",
          minutesAfterCreation: 25,
        },
        {
          type: "customer",
        ...
        },
        {
          type: "internal_note",
          author: "Travis Ortega",
          body: "Sent the City bill (PDF) and pro-ration spreadsheet to Derek. Scheduled Thursday 2 PM call. Note for next year: we should proactively notify all Fremont tenants 30 days before Q1 of any new municipal pass-throughs so this doesn't land cold in a monthly invoice again.",
          minutesAfterCreation: 180,
        },
      ],
    },
